/**
 * @file port_windows.c
 * @brief Native Windows simulator port implementation for SertOS.
 *
 * Provides simulated architecture stack frames, critical section masking,
 * and context switching hooks for MinGW-w64 on Windows.
 */
...
void* sertos_port_stack_init(void* stack_top, void* stack_limit, SertosTaskFunction entry, void* param)
{
    ...
    frame->psr = (void*)(uintptr_t)0x01000000U; /* Default Thumb state bit */
